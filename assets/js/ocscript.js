...
function imenus_data9(){
   ...
   ---------------------------------------------*/
	...
	this.sub_pointer_image = '/roboadmin/images/nextblue.gif'
	this.sub_pointer_image_width = '5'
	this.sub_pointer_image_height = '9'
	this.sub_pointer_image_offx = '2'
	this.sub_pointer_image_offy = '0'

	this.sub_pointer_image7 = '/robomail/roboadmin/images/next.gif'
