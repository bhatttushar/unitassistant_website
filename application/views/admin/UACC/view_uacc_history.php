...
<style type="text/css">
    ...
    .box-body .form-control, .box-body .monthpicker {
        width: 74%;
...
<div class="content-wrapper">
    <section class="content-header">
        <h1> <i class="fa fa-history"></i> UACC Client History </h1>
    </section>

    <section class="content">
        <div class="col-md-08">
          <div class="box box-primary">
            <div class="box-header"> <h3 class="box-title">History Details</h3> </div><!-- /.box-header -->
                <div class="box-body">
                    <div class="form-group">
                        <label>Director Title </label>
                        <select class="form-control" name="cc_director_title">
                    ...
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" class="form-control" name="name" value="<?php echo empty($data['name']) ? '' : $data['name'];?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="cell_number" value="<?php echo empty($data['cell_number']) ? '' : $data['cell_number'];?>">
                    </div>
                    <div class="form-group">
                        <label>Consultant Id</label>
                        <input type="text" class="form-control" name="consultant_number" id="consultant_number" value="<?php echo empty($data['consultant_number']) ? '' : $data['consultant_number'];?>" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="pmt_type" id="pmt_type" class="form-control">
