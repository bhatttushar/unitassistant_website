<div class="content-wrapper">
    <section class="content-header">
      <h1> <i class="fa fa-envelope"></i> UACC Admin Email Management </h1>
    </section>
    ...
    <div class="box-header">
        <h3 class="box-title">Email Listing</h3>
                ...
                <div class="box-body table-responsive">
                  <table class="table table-hover" id="uacc_admin_email_table">
                    <thead>
                      <tr>
                        <th>#</th>
                        <th>Sent By</th>
                      ...
                      <?php 
                          ...
                          foreach ($data as $val) { ?>
                              <tr class="odd gradeX">
                                  ...
                                  <td>Admin</td>
                                  <td> <?php echo getUACCName($val['id_cc_newsletter_client']);?> </td>
                                  <td>
                                    <?php 
