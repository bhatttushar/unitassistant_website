    ...
    <div class="wrapper">
      <header class="main-header">
        <a href="<?php echo base_url(); ?>" class="logo">
          <span class="logo-mini"><b>Billing</b></span>
      ...
      <aside class="main-sidebar">
        <section class="sidebar">
          <ul class="sidebar-menu">
            <li class="header">BILLING NAVIGATION</li>
            <li class="treeview">
            ...
            <li class="treeview">
              <a href="<?php echo base_url('billing/unsubscribed-client'); ?>" >
                <i class="fa fa-users"></i>
                <span>Unsubscribed Client</span>
              </a>
            </li>
            <li class="treeview">
              <a href="<?php echo base_url('billing/credit-payment'); ?>" >
                <i class="fa fa-credit-card"></i>
                <span>Credit Payment</span>
              </a>
            </li>
            <li class="treeview">
              <a href="<?php echo base_url('billing/reports'); ?>" >
