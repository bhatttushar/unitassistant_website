<?php 
	if ($this->uri->segment(1)=='edit-bellafizz') { ?>
		<form class="new-form" method="post" action="">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="col-md-3">
						<input type="button" name="save_note" class="btn btn-success pull-right save-note" value="Add Note" onclick="saveBellafizzNote(<?php echo $data['id_bellafizz']?>);">
				...
				<div class="col-md-12 notes_listing">
					<div class="chat_area">
						<ul class="list-unstyled">
							...
							<?php }
							if ($nCount >= 8) { ?>
								<a href="javascript:void(0);" class="btn btn-default pull-right show-btn" onclick="loadNewBellafizzNotes(<?php echo $data['id_bellafizz']; ?>, 'all')">View All Activity</a>
							<?php } ?>
				        </ul>
					</div>
				</div>
