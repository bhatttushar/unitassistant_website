<?php 
    ...
    $lg=( (isset($_GET['language']) && $_GET['language']==1) || !isset($_GET['language']) ) ? 'E' : 'F'; 
    $topImg = (isset($_GET['language']) && $_GET['language']==3) ? 'UAFLYERCanadaFR.jpg' : 'UAFLYERCanadaEN.jpg';
    ...
    <div class="row main">
        ...
        <div class="col-sm-6 chooseLanguage">
            <div class="form-group">
              ...
              <select class="form-control" id="language" name="language">
                ...
                <option value="3" <?php echo $french; ?> ><?php echo lang_label('french', $lg); ?></option>
              </select>
            </div>
        </div>
        ...
        <form method="post" action="" enctype="multipart/form-data">
            <div class="main-login main-center col-sm-6">
                <div class="row mb15">
                    <div class="col-sm-4">    
                        <label><?php echo lang_label('service_for', $lg); ?> *</label>
                    </div>
                    <div class="col-sm-8 pl0">
                        <select name="add_to" class="form-control" required>
                            <option value=""><?php echo lang_label('select_service_for', $lg); ?></option>
                            <option value="1"><?php echo lang_label('customer_communication', $lg); ?></option>
                            <option value="2"><?php echo lang_label('director', $lg); ?></option>
                            <option value="3"><?php echo lang_label('both_service', $lg); ?></option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb15">
                    ...
                    <div class="col-sm-8 pl0">
                        <input type="email" class="form-control" name="email" id="email" placeholder="<?php echo lang_label('your_email', $lg); ?>" onblur="reggieUniqueEmail(this.value, '1', '');" required>
                ...
                <div class="row mb15">
                    ...
                    <div class="col-sm-8 pl0">
                       <input type="text" class="form-control" name="unit_name" id="unit_name" placeholder="<?php echo lang_label('sally_star', $lg); ?>">
                    </div>
                </div>
                ...
                <div class="row mb15">
                    ...
                    <div class="col-sm-8 pl0">
                       <input type="text" class="form-control" name="unit_goal" id="unit_goal" placeholder="<?php echo lang_label('pink_cadillac', $lg); ?>">
                    </div>
                </div>
            ...
            <div class="main-login main-center col-sm-6">
                ...
                <div class="row mb15">
                    <label class="col-sm-4"><?php echo lang_label('credit_card', $lg); ?> *</label>
                    <div class="col-sm-8">
                        <div class="row mb15">
                            <div class="col-sm-6 pl0">
                                <input type="text" name="cc_number" class="form-control" placeholder="<?php echo lang_label('credit_card', $lg); ?>" required >
                            </div>

                            <div class="col-sm-6 pl0">
                                <input type="text" name="cc_code" class="form-control" placeholder="<?php echo lang_label('security_code', $lg);?>" required>    
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-6 pl0">
                                <input type="text" class="form-control" name="cc_expir_date" placeholder="<?php echo lang_label('expiration_date', $lg);?>" maxlength="5" required>
                            </div>

                            <div class="col-sm-6 pl0">
                                <input type="text" name="cc_zip" class="form-control" placeholder="<?php echo lang_label('postal_code', $lg);?>" required>    
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="ThankYouRCModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body" style="font-size: 18px;">
        <p><?php echo lang_label('thank_you', $lg); ?></p>
      </div>
    </div>
