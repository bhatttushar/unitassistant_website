...
<form class="new-form" method="post" action="" id="addUACCNoteForm">
	<div class="form-group">
		<div class="row">
			...
			<div class="col-md-3">
				...
				<input type="hidden" name="client_hidden_name" id="name_client" value="<?php echo isset($data['name']) ? $data['name'] : ''; ?>">
			</div>
						...
						foreach ($notedata as $val) {
							...
							<li class="left clearfix">
				                <span class="chat-img1 pull-left">
			                    	<?php
									$sProfile = empty($val['profile_pic']) ? base_url('assets/images/user_profile/female.jpg') : base_url('assets/images/user_profile/'.$val['profile_pic']);
									?>
			                    ...
			                    <div class="chat-body1 clearfix">
			                        ...
			                        <?php }
										if ($val['id_cc_newsletter'] != '' && $val['id_cc_newsletter'] == oldCCN($id_cc_newsletter) ) {
