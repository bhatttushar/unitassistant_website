        ...
        <div class="row">
        	<div class="col-sm-12">
        		...
        		<div class="col-sm-6">
        			...
        			<form action="<?php echo base_url('uacc-billing/all-invoice-report/month'); ?>" name="monthvice" method="post">
        		...
        		<div class="col-sm-6 hborder">
        			...
        			<form name="yearvice" action="<?php echo base_url('uacc-billing/all-invoice-report/allYear');?>" method="post">
					  <div class="form-group col-sm-6">
        		...
        		<div class="col-sm-6">
        			<h3 class="text-center">Monthly Report for all clients </h3>
        			<form action="<?php echo base_url('uacc-billing/bank-report/month'); ?>" name="monthvice" method="post">
						 <div class="form-group col-sm-6 month">
						    <label for="email">Set Month From</label>
						    <select class="form-control" name="month_from">
		                        <option value="01">January</option>
        		...
        		<div class="col-sm-6 hborder">
        			<h3 class="text-center">Yearly Report for all clients </h3>
        			<form action="<?php echo base_url('uacc-billing/bank-report/allYear'); ?>" name="yearvice" method="post">
						  <div class="form-group col-sm-6">
						    <label for="email">Select Year</label>
						    <select class="form-control" name="selectedYear">
						    	<option value="<?php echo date('Y'); ?>"><?php echo date('Y'); ?></option>
        		...
        		<hr style="border-color: #000;">
        		<div class="col-sm-12">
        			<form method="post" action="<?php echo base_url('uacc-billing/item-report'); ?>" name="item_report">
			        	<div class="col-sm-8">
						  	<div class="form-group col-sm-6 month">
							    <label for="email">Set Month From</label>
							    <select class="form-control" name="month_from">
