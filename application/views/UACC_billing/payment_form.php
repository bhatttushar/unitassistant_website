        	...
        	<div class="col-sm-12">
				...
				<div class="col-sm-8">
					<div id="sq-ccbox">
					    ...
					    <form id="nonce-form" novalidate action="<?php echo base_url('uacc-billing/proccess-payment')?>" method="post">
					      ...
					      <input type="hidden" id="id_cc_invoice" name="id_cc_invoice" value="<?php echo !empty($data['id_cc_invoice']) ? $data['id_cc_invoice'] : '';?>">
					    </form>
					  </div>
				</div>
        	</div>
